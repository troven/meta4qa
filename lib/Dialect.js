...
//    scope = _.extend(scope, config.vars);
    ...
    this.learn = function(fn, name) {
        ...
        controllers[name] = fn(self.library, self.config, scope, self );
...
//        debug("annotations: %s", _.keys(controllers));
        return self;
    }
...
//        debug("scenario-scoped: %s", _.keys(controllers));
        return self;
    }
...
//        debug("feature-scoped: %s", _.keys(controllers));
        return self;
    }
